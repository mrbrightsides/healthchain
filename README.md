...
![RANTAI HealthChain](https://img.shields.io/badge/RANTAI-HealthChain-blue?style=for-the-badge)
![AI Powered](https://img.shields.io/badge/AI-45+%20Modes-purple?style=for-the-badge)
![Blockchain](https://img.shields.io/badge/Blockchain-Ethereum-purple?style=for-the-badge)
![Next.js](https://img.shields.io/badge/Next.js-15.3.8+-black?style=for-the-badge)
![TypeScript](https://img.shields.io/badge/TypeScript-5.8.3-blue?style=for-the-badge)
...
#### 🏥 **6 AI-Powered Health Centers** (30 AI Modes)
...
- Workout Optimizer - Personalized training programs
- Form Coach - Exercise technique guidance
- Injury Prevention - Pain analysis & recovery
- Progress Analyzer - Breakthrough strategies
- Sport-Specific Training - Running, football, badminton

**🥗 Nutrition AI Coach** (5 Modes)
- Meal Planner - Complete meal plans with macros
- Nutrition Analyzer - Food breakdown & alternatives
- Supplement Advisor - Evidence-based recommendations
- Weight Management - Sustainable strategies
- Food Consultant - Indonesian cuisine optimization

**👶 Maternal & Child AI** (5 Modes)
- Pregnancy Advisor - Week-by-week guidance
- Child Development Expert - Milestone tracking
- Feeding Consultant - ASI, formula, MPAI guidance
- Growth Interpreter - WHO percentile analysis
- Vaccination Guide - IDAI schedule optimization

</td>
<td width="50%">

**❤️ Heart Health AI** (5 Modes)
- Risk Analysis - Framingham cardiovascular score
- Symptom Checker - Chest pain, palpitations triage
- Lifestyle Guidance - DASH diet, exercise plans
- Trend Analysis - Longitudinal BP/HR patterns
- Emergency Assessment - Cardiac emergency triage

**🧠 Mental Wellness AI** (5 Modes)
- Mental Health Companion - Empathetic support
- Anxiety Management - CBT techniques, grounding
- Sleep Coach - CBT-I, sleep hygiene strategies
- Grief Support - Bereavement counseling
- Mindfulness Guide - Meditation, breathing techniques

**👁️ Eye Health AI** (5 Modes)
- Vision Analysis - Visual acuity interpretation
- Screen Strain Consultant - CVS diagnosis & solutions
- Eyewear Guidance - Prescription interpretation
- Vision Improvement - Exercises, nutrition
- Symptom Interpreter - Emergency eye triage

</td>
</tr>
</table>

#### 🚨 **Clinical & Emergency AI Systems** (15+ Modes)
...
- Medical Translator - Indonesian ↔ English medical terms
- General Emergency Consultant - Expert guidance

**🩺 AI Second Opinion Assistant**
...
### 🏥 **16 Integrated Healthcare Modules**

1. **Patient Portal** 💙 - Complete health records & blockchain wallet management
2. **Doctor Panel** 💚 - Patient management, AI-assisted observations & prescriptions
3. **Insurance Automation** 💜 - AI claims processing, BPJS integration, fraud detection
4. **Health Analytics** 🧡 - AI-powered research insights & predictive analytics
5. **Lab Results** 💙 - Auto-import with AI interpretation (Prodia, Kimia Farma, Pramita)
6. **Knowledge Center** 💙 - AI medical assistant with comprehensive FAQ (Indonesian)
7. **Immunization Tracker** 💉 - AI vaccination schedules & NFT certificates
8. **Pharmacy Blockchain** 💊 - AI drug intelligence & price comparison
9. **Emergency SOS** 🚨 - AI-powered emergency triage & response system
10. **Second Opinion Network** 🩺 - AI case analysis & multi-doctor consultations
11. **Predictive Health AI** 🤖 - ML-powered disease risk prediction (85-92% confidence)
12. **Mental Health Sanctuary** 🌸 - AI therapy, mood tracking, crisis support
13. **Clinical Notes** 📋 - AI clinical intelligence suite
14. **Medical Imaging** 🖼️ - AI vision analysis with Gemini Vision API + IPFS storage
15. **Voice Assistant** 🎙️ - ElevenLabs AI voice in Bahasa Indonesia (24/7)
16. **Health Centers** 🏥 - 6 specialized centers with 30 AI modes

### 🎮 **6 Specialized Health Centers**

Each center includes comprehensive self-assessments, tracking tools, AND dedicated AI assistants:

- **💪 Fitness Center** - Goal setting, 4 workout programs, activity tracking + 5 AI modes
- **🥗 Nutrition Center** - BMI calculator, meal planning, vitamin checker + 5 AI modes
- **👶 Maternal & Child** - Pregnancy tracker, child development, growth charts + 5 AI modes
- **❤️ Heart Health** - CV risk assessment, BP tracking, heart rate zones + 5 AI modes
- **🧠 Mental Health** - Stress assessment, meditation timer, mood tracker + 5 AI modes
- **👁️ Eye Health** - Vision tests, color blindness screening, eye exercises + 5 AI modes
...
### ⛓️ Blockchain Mode (Wallet Connected)
...
│   │   │   ├── fitness-ai/       # Fitness AI Coach API
│   │   │   ├── nutrition-ai/     # Nutrition AI Coach API
│   │   │   ├── maternal-child-ai/ # Maternal & Child AI API
│   │   │   ├── heart-health-ai/  # Heart Health AI API
│   │   │   ├── mental-wellness-enhanced-ai/ # Mental Wellness AI API
│   │   │   ├── eye-health-ai/    # Eye Health AI API
│   │   │   ├── emergency-ai/     # Emergency Assistant AI API
│   │   │   ├── second-opinion-ai/ # Second Opinion AI API
│   │   │   ├── lab-interpretation-ai/ # Lab Results AI API
│   │   │   ├── vaccine-ai/       # Vaccine Intelligence AI API
│   │   │   ├── mental-health-ai/ # Mental Health Sanctuary AI API
│   │   │   ├── knowledge-ai/     # Medical Knowledge AI API
│   │   │   ├── pharmacy-ai/      # Pharmacy Intelligence AI API
│   │   │   ├── clinical-ai/      # Clinical Intelligence AI API
│   │   │   ├── claims-ai/        # Smart Claims AI API
│   │   │   ├── analytics-ai/     # Health Insights AI API
│   │   │   └── ...               # Other API routes
│   │   ├── layout.tsx            # Root layout with Farcaster integration
│   │   └── page.tsx              # Main homepage
│   ├── components/               # React components
│   │   ├── ui/                   # shadcn/ui components (56 components)
│   │   ├── health-centers/       # 6 health center modules with AI
│   │   ├── [ai-assistant].tsx    # 16 AI assistant components
│   │   ├── [module-name].tsx     # 16 major feature modules
│   │   └── ...                   # Utility components
...
│   └── .well-known/
│       └── farcaster.json        # Farcaster mini-app configuration
...
- ✅ **Blockchain Immutability** - Tamper-proof records on Ethereum
- ✅ **Patient-Controlled Access** - Grant/revoke permissions via smart contracts
- ✅ **SIWE Authentication** - Cryptographic wallet-based login
- ✅ **IPFS Storage** - Decentralized medical file storage (Pinata)
- ✅ **Transaction Hash Verification** - Every action verifiable on-chain
- ✅ **Privacy-First Design** - Anonymous support groups, encrypted journals
- ✅ **AI Safety Protocols** - Medical disclaimers, crisis detection, professional referrals
- ✅ **Local Data Storage** - Guest mode data stored locally (no cloud uploads)
...
- 🤖 **AI Enhancements** - Improve AI response quality, add new modes
- 🌐 **Internationalization** - Add regional Indonesian languages (Javanese, Sundanese)
- ⛓️ **Blockchain Features** - New smart contracts, L2 integration
- 🏥 **Medical Modules** - Additional health centers, specialized diagnostics
...
- **AI Features**: See [AI Intelligence System](#-ai-intelligence-system) above
...
### Q1 2026 (Completed ✅)
- ✅ 16 integrated healthcare modules
- ✅ 45+ specialized AI modes (Google Gemini 2.0 Flash)
- ✅ 6 AI-powered health centers
- ✅ BPJS blockchain integration
- ✅ Voice assistant (ElevenLabs Indonesian)
- ✅ Medical imaging analysis (Gemini Vision)
...
- 🔄 AI voice diagnosis (symptom checker via voice)
- 🔄 Ethereum mainnet deployment

### Q3 2026 (Planned 🌟)
- 🔄 Partnership with 100+ Indonesian hospitals
...
1. **Artificial Intelligence** - Making world-class medical expertise accessible 24/7
2. **Blockchain Technology** - Giving patients true ownership of their health data
3. **Indonesian Healthcare** - Solving real problems for 270M+ people
...
**Made with ❤️ for the future of Indonesian healthcare**

*Revolutionizing healthcare through AI & blockchain technology*

### 🚀 **45+ AI Modes • 16 Modules • 6 Health Centers • 270M+ Potential Users**
